...
# 1. Frontend Layer
create_box(ax, 0.5, 9.5, 2, 1.2, 'FRONTEND\n(script.js)\n\nUser Input\nChat Interface', frontend_color)

# 2. API Layer
create_box(ax, 4, 9.5, 2, 1.2, 'FASTAPI\n(app.py)\n\n/api/query\nEndpoint', backend_color)

# 3. RAG System
create_box(ax, 7.5, 9.5, 2, 1.2, 'RAG SYSTEM\n(rag_system.py)\n\nOrchestrator', backend_color)

# 4. Session Manager
create_box(ax, 0.5, 7.5, 1.8, 1, 'SESSION\nMANAGER\n\nConversation\nHistory', backend_color, fontsize=9)

# 5. AI Generator
create_box(ax, 4, 7.5, 2, 1, 'AI GENERATOR\n(ai_generator.py)\n\nClaude API', ai_color)

# 6. Tool Manager
create_box(ax, 7.5, 7.5, 2, 1, 'TOOL MANAGER\n(search_tools.py)\n\nSearch Tools', backend_color)
...
# Legend
legend_y = 2
ax.text(6, legend_y + 0.5, 'COMPONENTS:', ha='left', va='center', fontsize=12, weight='bold')
...
plt.tight_layout()
plt.savefig('/Users/jackivers/Projects/learning/claudecode/starting-ragchatbot-codebase/query_flow_diagram.png', 
            dpi=300, bbox_inches='tight', facecolor='white')
plt.savefig('/Users/jackivers/Projects/learning/claudecode/starting-ragchatbot-codebase/query_flow_diagram.pdf', 
